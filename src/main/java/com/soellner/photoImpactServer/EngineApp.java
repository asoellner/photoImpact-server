...
/*
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(com.soellner.photoImpactServer.JsonMoxyConfigurationContextResolver.class);
        resources.add(com.soellner.photoImpactServer.GreetingController.class);
